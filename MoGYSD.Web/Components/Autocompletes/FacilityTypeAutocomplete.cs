...
{
    public partial class FacilityTypeAutocomplete : MudAutocomplete<int?>
    {
        public FacilityTypeAutocomplete()
        {
        ...
        [Inject]
        private ISearchService<FacilityType> SearchService { get; set; } = default!;
        ...
        {
            IEnumerable<FacilityType> filtered = SearchService.DataSource;
