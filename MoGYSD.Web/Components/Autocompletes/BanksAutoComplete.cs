...
{
    public partial class BanksAutoComplete : MudAutocomplete<int?>
    {
        public BanksAutoComplete()
        {
        ...
        [Inject]
        private ISearchService<Bank> SearchService { get; set; } = default!;
        ...
        {
            IEnumerable<Bank> filtered = SearchService.DataSource;
